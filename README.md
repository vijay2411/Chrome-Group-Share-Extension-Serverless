...
🙋🏼‍♂️ You're researching something. You've got 8 tabs open, neatly organized in a Chrome Tab Group called "Project Research." Now you want to share all those tabs with a coworker. What do you do — copy-paste 8 URLs one by one?
...
| 🕵️ **Zero data collection** | No analytics. No telemetry. No cookies. No fingerprinting. No accounts. No tracking of any kind. |
...
- ♾️ Links never expire and there's no limit on how many you can create
...
- 🕵️ No data collection, no analytics, no cookies
...
### 🅰️ Option A: Extension to Extension
...
### 🅱️ Option B: Extension to Web Page
...
- 🛡️ **AES-256-GCM** — authenticated encryption, tamper-proof
- ⏱️ **PBKDF2 100k iterations** — computationally expensive key derivation, resists brute-force
